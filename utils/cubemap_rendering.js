...
function updateCubemap(unmirroredCameraMat, eyeMat, thirdPersonCameraMat, neckMat, upperTorsoMat, torsoMatrix, boxRotation, frameTime, armRotationAdjustment, interpolationFactor, legSettings){
    ...
    for (var ii=0;ii<6;ii++){
        ...
        drawSingleScene(copiedMat, true, eyeMat, thirdPersonCameraMat, neckMat, upperTorsoMat, torsoMatrix, boxRotation, frameTime, armRotationAdjustment, interpolationFactor, legSettings);
        gl.clear(gl.DEPTH_BUFFER_BIT);
        drawSingleScene(copiedMat, false, eyeMat, thirdPersonCameraMat, neckMat, upperTorsoMat, torsoMatrix, boxRotation, frameTime, armRotationAdjustment, interpolationFactor, legSettings);
	}
	gl.bindFramebuffer(gl.FRAMEBUFFER, null);
...
function renderViewUsingCmap(){
    ...
    gl.uniform2f(activeShaderProgram.uniforms.uOffsetXy, 0,-0.3333);
